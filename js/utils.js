...
/** Nome curto do dia */
function getDiaSemanaCurto(dataStr) {
  if (!dataStr) return '';
 ...
 */
function formatarDuracao(totalMinutos, showSign = false) {
 ...
 * Permite número ímpar (incompleto) mas avisa.
 */
function validarBatidas(batidas) {
  const erros = [];
